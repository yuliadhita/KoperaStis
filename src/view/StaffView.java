...
public class StaffView extends javax.swing.JFrame {
    ...
    public StaffView(Staff s) {
        ...
        if (s != null) {
            this.staff = s;
            initStaffView("Staff", s.getNama());
        } else {
            initStaffView("Staff", "Staff Name");
        }
    }
    ...
    private void initStaffView(String roleView, String usernameView) {
            ...
            public void menuSelected(int menuIndex, int submenuIndex) {
                ...
                if (menuIndex == 1) {
                    ...
                    Thread newThread = new Thread(() -> {
                        try {
                            mainPanel.showForm(new BarangForm());
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    });
