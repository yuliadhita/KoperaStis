...
public class MainForm extends javax.swing.JPanel {
    ...
    private Barang barangSelected;
    private List<Barang> barangSearched;
    ...
    public MainForm(Pengguna pLogin) {
        ...
        lblLogo.setIcon(new FlatSVGIcon("img/logo/logo-green.svg", 3f));
        lblLogo.setIconTextGap(12);
        lblLogo.setFont(new Font("sansserif", 1, 24));
        lblLogo.setForeground(cp.getColor(1));
        lblLogo.setText("KoperaStis");
        ...
        lblProfile.setIcon(new FlatSVGIcon("img/icon/account.svg", 4.2f));
        ...
        btnPlus.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent arg0) {
                if (jumlahBeli < barangSelected.getKuantitas()) {
                    jumlahBeli += 1;
                    System.out.println(jumlahBeli);
                    inputJumlah.setText(String.valueOf(jumlahBeli));
                    subtotal = barangSelected.getHarga() * jumlahBeli;
        ...
        btnBayar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                Role r = new Role(6, "Kasir");
                User u = new User(-1, "Pembelian", "pembelian");
                Staff s = new Staff(-1, "Self-Service", "2024-06-04", "777-7777", "Online", r, u);

                System.out.println("Bayar dulu ");

                Transaksi t = new Transaksi(jumlahBeli, stringDateToday, s, barangSelected, penggunaLogin);
                tc.insertDataTransaksi(t);

                barangSelected.setKuantitas(barangSelected.getKuantitas() - jumlahBeli);
                bc.updateDataBarang(barangSelected.getIdBarang(), barangSelected);

                JOptionPane.showMessageDialog(null, "Berhasil membeli barang!");
            ...
            public void keyReleased(KeyEvent e) {
                ...
                Thread newThread = new Thread(() -> {
                    try {
                        Thread.sleep(400);
                        searchInput = searchField.getText();
                        barangSearched = bc.showDataBarangAsList(searchInput);
                        if (barangSearched != null) {
                            SwingUtilities.invokeLater(() -> {
                                itemPanel.removeAll();
                                for (Barang barang : barangSearched) {
    ...
    private void initCheckout(Barang barang) {
        lblImage.setIcon(new FlatSVGIcon("img/icon/barang-img.svg", 0.4f));
        lblNama.setText(barang.getNamaBarang());
        lblHarga.setText("Rp " + String.valueOf(barang.getHarga()));
        lblStok.setText(String.valueOf(barang.getKuantitas()) + " pcs");
        lblSubtotal.setText(String.valueOf(barang.getHarga()));
    ...
    public void showItem(String query) {
        ...
        BarangTable to = (BarangTable) bc.showDataBarang(query);
        Barang barang;
        for (int i = 0; i < to.getRowCount(); i++) {
            barang = (Barang) to.getValueAt(i, 4);
            if (barang.getKuantitas() > 0) {
                addItem(barang);
            }
        }
    ...
    private void addItem(Barang barang) {
        Item item = new Item();
        item.setData(barang);
        item.addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                if (SwingUtilities.isLeftMouseButton(e)) {
                    //event.itemClicked(item, barang);
                    System.out.println(barang.getNamaBarang());
                    //pindah card panel, siapin data dari barang yang dipencet
                    barangSelected = barang;
                    initCheckout(barangSelected);
    ...
    private void initComponents() {
        ...
        searchField = new view.swing.component.TextFieldInput();
        lblProfile = new javax.swing.JLabel();
        lblUsername = new javax.swing.JLabel();
        btnLogout = new javax.swing.JLabel();
        body = new javax.swing.JPanel();
        scrollPane = new javax.swing.JScrollPane();
        itemPanel = new view.pengguna.ItemPanel();
        ...
        btnMinus = new view.swing.component.ButtonRectangle();
        inputJumlah = new view.swing.component.TextFieldInput();
        btnPlus = new view.swing.component.ButtonRectangle();
        jLabel3 = new javax.swing.JLabel();
        lblRp = new javax.swing.JLabel();
        lblSubtotal = new javax.swing.JLabel();
        btnBayar = new view.swing.component.ButtonRound();
        ...
        viewItemCard.setForeground(javax.swing.UIManager.getDefaults().getColor("Button.default.background"));
        ...
        itemPanel.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
    ...
    private view.swing.component.ButtonRound btnBayar;
    private javax.swing.JLabel btnLogout;
    private view.swing.component.ButtonRectangle btnMinus;
    private view.swing.component.ButtonRectangle btnPlus;
    private javax.swing.JPanel cardLayoutPanel;
    private javax.swing.JPanel checkoutItemCard;
    private javax.swing.JPanel header;
    private view.swing.component.TextFieldInput inputJumlah;
    private view.pengguna.ItemPanel itemPanel;
    ...
    private view.swing.component.TextFieldInput searchField;
