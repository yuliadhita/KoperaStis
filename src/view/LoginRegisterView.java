...
import components.exception.NamaKosongException;
import components.exception.noTelpLengthException;
import components.exception.UsernameKosongException;
import components.exception.AlamatKosongException;
import components.exception.NoHpKosongException;
import components.exception.UniqueException;
import components.exception.NoHpNumericException;
import components.exception.PasswordKosongException;
...
public class LoginRegisterView extends javax.swing.JFrame {
    ...
    public LoginRegisterView() {
        ...
        illustrationLogin.setIcon(new FlatSVGIcon("img/illustration/Cash Payment-amico.svg", 0.9f));
        illustrationRegister.setIcon(new FlatSVGIcon("img/illustration/Cash Payment-rafiki.svg", 0.9f));
    ...
    private void initComponents() {
        ...
        baseLoginPanel = new view.panel.LoginRegisterBasePanel();
        leftLoginPanel = new javax.swing.JPanel();
        loginTitle = new javax.swing.JLabel();
        registerHere = new javax.swing.JLabel();
        belumPunyaAkun = new javax.swing.JLabel();
        loginBtn = new view.swing.component.Button();
        textFieldLoginPanel = new javax.swing.JPanel();
        inputUsernameLogin = new view.swing.component.TextField();
        inputPasswordLogin = new view.swing.component.PasswordField();
        showPassLogin = new javax.swing.JCheckBox();
        rightLoginPanel = new view.swing.GradientPanelRight();
        illustrationLogin = new javax.swing.JLabel();
        title = new javax.swing.JLabel();
        slogan = new javax.swing.JLabel();
        btnCloseLogin = new view.swing.component.ButtonOutLine();
        baseRegisterPanel = new view.panel.LoginRegisterBasePanel();
        ...
        registerBtn = new view.swing.component.Button();
        textFieldRegisterPanel = new javax.swing.JPanel();
        showPassRegister = new javax.swing.JCheckBox();
        inputUsernameRegister = new view.swing.component.TextField();
        inputNamaRegister = new view.swing.component.TextField();
        inputNoTelpRegister = new view.swing.component.TextField();
        inputAlamatRegister = new view.swing.component.TextField();
        inputPasswordRegister = new view.swing.component.PasswordField();
        rightRegisterPanel = new view.swing.GradientPanelRight();
        illustrationRegister = new javax.swing.JLabel();
        btnCloseRegister = new view.swing.component.ButtonOutLine();
        ...
        loginTitle.setForeground(new java.awt.Color(46, 80, 144));
        loginTitle.setText("Login");

        registerHere.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        registerHere.setForeground(new java.awt.Color(39, 116, 174));
        ...
        title.setFont(new java.awt.Font("Segoe UI", 1, 40)); // NOI18N
        title.setForeground(new java.awt.Color(255, 255, 255));
        title.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        title.setText("KoperaStis");
        ...
        slogan.setText("Penyedia Kebutuhan Belajarmu di Politeknik Statistika STIS!");
        ...
        registerTitle.setForeground(new java.awt.Color(46, 80, 144));
        registerTitle.setText("Register");

        loginHere.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        loginHere.setForeground(new java.awt.Color(39, 116, 174));
        ...
        leftRegisterPanelLayout.setVerticalGroup(
            ...
            .addGroup(leftRegisterPanelLayout.createSequentialGroup()
                ...
                .addGap(12, 12, 12)
                .addComponent(textFieldRegisterPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 420, Short.MAX_VALUE)
        ...
        title2.setFont(new java.awt.Font("Segoe UI", 1, 40)); // NOI18N
        title2.setForeground(new java.awt.Color(255, 255, 255));
        title2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        title2.setText("KoperaStis");
        ...
        slogan2.setText("Penyedia Kebutuhan Belajarmu di Politeknik Statistika STIS!");
            ...
            try{
                ...
                if(inputUsernameLogin.getText().equals("master") && temp.equals("master")) {
                    ...
                    switch (sLogin.getRole().getIdRole()) {
                        case 1:
                            JOptionPane.showMessageDialog(null, "Login as " + sc.returnName(index) + " - Staff");
                            StaffView av = new StaffView(sLogin);
                            this.dispose();
                            av.setVisible(true);
                            break;
                        case 2:
    ...
    private view.panel.LoginRegisterBasePanel baseLoginPanel;
    private view.panel.LoginRegisterBasePanel baseRegisterPanel;
    private javax.swing.JLabel belumPunyaAkun;
    private view.swing.component.ButtonOutLine btnCloseLogin;
    private view.swing.component.ButtonOutLine btnCloseRegister;
    private javax.swing.JPanel cardLayoutPanel;
    private javax.swing.JLabel illustrationLogin;
    private javax.swing.JLabel illustrationRegister;
    private view.swing.component.TextField inputAlamatRegister;
    private view.swing.component.TextField inputNamaRegister;
    private view.swing.component.TextField inputNoTelpRegister;
    private view.swing.component.PasswordField inputPasswordLogin;
    private view.swing.component.PasswordField inputPasswordRegister;
    private view.swing.component.TextField inputUsernameLogin;
    private view.swing.component.TextField inputUsernameRegister;
    private javax.swing.JPanel leftLoginPanel;
    private javax.swing.JPanel leftRegisterPanel;
    private view.swing.component.Button loginBtn;
    private javax.swing.JLabel loginHere;
    private javax.swing.JLabel loginTitle;
    private view.swing.component.Button registerBtn;
    private javax.swing.JLabel registerHere;
    private javax.swing.JLabel registerTitle;
    private view.swing.GradientPanelRight rightLoginPanel;
    private view.swing.GradientPanelRight rightRegisterPanel;
