 ...
 * @author yulia
 */
public class PengadaanBarangCard extends javax.swing.JPanel {
    ...
    public PengadaanBarangCard(PengadaanBarang pengadaanBarang) {
        initComponents();
        ...
        initLeftPic("default");
        initBtn();
        initAttributeAndLabel(pengadaanBarang.getTanggalPengadaan(), pengadaanBarang.getBarang().getNamaBarang(), String.valueOf(pengadaanBarang.getKuantitas()));
    }

    public void initAttributeAndLabel(String tgl, String namaBarang, String jmlBarang) {
        lblTglPengadaan.setText(tgl);
        lblNamaBarang.setText(namaBarang);
        lblJmlBarang.setText(jmlBarang);
    }
    ...
    private void initComponents() {
        ...
        lblNamaBarang.setText("namaBarang");
        infoPanel.add(lblNamaBarang, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 28, -1, -1));

        lblJmlBarang.setForeground(new java.awt.Color(255, 255, 255));
        lblJmlBarang.setText("jmlBarang");
        infoPanel.add(lblJmlBarang, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 50, -1, -1));
