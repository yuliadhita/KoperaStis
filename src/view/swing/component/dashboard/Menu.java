...
import view.swing.component.scrollbar.ScrollBarCustom;
...
public class Menu extends javax.swing.JPanel {
    ...
    public Menu(String title) {
        ...
        titleAndIcon.setIcon(new FlatSVGIcon("img/logo/logo-white.svg", 2f));
        titleAndIcon.setIconTextGap(12);
        titleAndIcon.setFont(new Font("Segoe UI", 1, 24));
        titleAndIcon.setText("KoperaStis");
    ...
    public void initMenuItemForSuperAdmin() {
        ...
        //addMenuItem(indexMenu++, new DashboardModelMenu(new FlatSVGIcon(iconDir + "inventory.svg", 0.5f), "Kelola Pengadaan Barang", new String[]{}));
    ...
    public void initMenuItemForStaff() {
        int indexMenu = 0;
        addMenuItem(indexMenu++, new DashboardModelMenu(new FlatSVGIcon(iconDir + "receipt.svg", 0.5f), "Kelola Data Transaksi", new String[]{}));
        addMenuItem(indexMenu++, new DashboardModelMenu(new FlatSVGIcon(iconDir + "barang.svg", 0.12f), "Kelola Data Barang", new String[]{}));
        addMenuItem(indexMenu++, new DashboardModelMenu(new FlatSVGIcon(iconDir + "inventory.svg", 0.5f), "Kelola Pengadaan Barang", new String[]{}));
        addMenuItem(indexMenu++, new DashboardModelMenu(new FlatSVGIcon(iconDir + "logout-white.svg", 0.5f), "Logout", new String[]{}));
    }

    //public void initMenuItemLogout() {
    //    int indexMenu = 0;
    //    addMenuItem(indexMenu++, new DashboardModelMenu(new FlatSVGIcon(iconDir + "logout-white.svg", 0.5f), "Logout", new String[]{}));
    //}
